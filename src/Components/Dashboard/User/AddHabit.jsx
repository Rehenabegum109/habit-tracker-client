...
//       const axiosSecure = AxiosSecure(user, logout, navigate);

//       // ✅ Post habit to backend
...
//   return (
//     <div className="max-w-xl mt-20 mx-auto p-4 shadow-md rounded-md">

//       {showSuccess && (
//         <div className="w-full flex justify-center mb-4">
//           <Lottie animationData={successAnimation} loop={false} style={{ width: 180, height: 180 }} />
//         </div>
//       )}
